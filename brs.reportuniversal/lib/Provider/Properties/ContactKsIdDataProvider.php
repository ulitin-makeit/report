...
/**
 * DataProvider для поля "КС ID клиента"
 */
class ContactKsIdDataProvider implements DataProviderInterface
{
	/** @var \mysqli Подключение к БД */
	private \mysqli $connection;

	/** @var array Данные КС ID [deal_id => value] */
	private array $data = [];

	/** @var string Код поля в Битрикс */
	private const FIELD_CODE = 'UF_CRM_CONTACT_KS_ID';

	/** @var string Название колонки в CSV */
	private const COLUMN_NAME = 'КС ID клиента';
